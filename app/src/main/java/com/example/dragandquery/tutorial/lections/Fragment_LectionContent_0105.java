...
public class Fragment_LectionContent_0105 extends Fragment_Content {
    ...
    //interface
    public interface Fragment_LectionContent_0105_Listener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //init coms
        rl_exercise = v.findViewById(R.id.frag_lectioncontent_0105);
        btn_go = v.findViewById(R.id.btn_lectioncontent_0105_go);
        context = getContext();
        rg = v.findViewById(R.id.rg_c1l5);
        rb1 = v.findViewById(R.id.rb1_c1l5);
        rb2 = v.findViewById(R.id.rb2_c1l5);
        rb3 = v.findViewById(R.id.rb3_c1l5);
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if(context instanceof Fragment_LectionContent_0105_Listener){
            listener = (Fragment_LectionContent_0105_Listener) context;
        } else{
