...
public class Fragment_Table_Tut extends Fragment {
    ...
    private static final Map<String, String> map = new HashMap<String, String>(){{
        ...
        put("04_04", "select raum.raumnummer, klasse.name from raum left outer join klasse on raum.raumnummer = klasse.raumnummer");
        put("04_05", "select Lehrkraft.Kürzel, Fach.Fachname from Lehrkraft left OUTER JOIN Fach on Lehrkraft.Kürzel = Fach.Fachleiterkürzel order by Fachname desc");
        put("04_06", "( Select Klasse.Name, Klasse.KlassenID, Lehrkraft.Kürzel From Klasse left join Lehrkraft ON Klasse.LehrkraftID=Lehrkraft.LehrkraftID ) union all ( Select Klasse.Name, Klasse.KlassenID, Lehrkraft.Kürzel From lehrkraft left join klasse ON Klasse.LehrkraftID=Lehrkraft.LehrkraftID where Klasse.LehrkraftID is null )");
