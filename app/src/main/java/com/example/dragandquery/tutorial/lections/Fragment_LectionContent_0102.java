...
public class Fragment_LectionContent_0102 extends Fragment_Content {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        //init coms
        rl_exercise = v.findViewById(R.id.frag_lectioncontent_0102);
        btn_go = v.findViewById(R.id.btn_lectioncontent_0102_go);
        context = getContext();
        rg = v.findViewById(R.id.rg_c1l2);
        rb1 = v.findViewById(R.id.rb1_c1l2);
        rb2 = v.findViewById(R.id.rb2_c1l2);
        rb3 = v.findViewById(R.id.rb3_c1l2);
