...
public class Fragment_LectionContent_0111 extends Fragment_Content {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        if(context instanceof Fragment_LectionContent_0111_Listener){
            listener = (Fragment_LectionContent_0111_Listener) context;
        } else{
